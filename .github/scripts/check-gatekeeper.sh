...
# smallest 10, hence 128. SB-1120 made it 167, the smallest still 10, hence 160.
[ "${ran:-0}" -ge 160 ] || die "expected at least 160 tests to run, unittest reported '${ran:-none}' — discovery broken?"
